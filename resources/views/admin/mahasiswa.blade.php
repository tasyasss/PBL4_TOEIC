                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukkan NIM" maxlength="10" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="noTelp" name="noTelp" placeholder="Masukkan nomor telepon" maxlength="15" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_nim" name="nim" placeholder="Masukkan NIM" maxlength="10" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="edit_alamat" name="alamat" rows="3" placeholder="Masukkan alamat" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="edit_noTelp">No. Telepon <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="edit_noTelp" name="noTelp" placeholder="Masukkan nomor telepon" maxlength="15" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="edit_programStudi">Program Studi <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="edit_fileKTM" name="fileKTM">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="edit_fileKTP" name="fileKTP">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="edit_filePasFoto" name="filePasFoto">
