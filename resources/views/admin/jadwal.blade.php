                        ...
                        <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th class="border-0 font-weight-bold text-gray-700 py-3">Tanggal Pelaksanaan Ujian</th>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="totalKuota" placeholder="Masukkan total kuota" min="1" required>
                    </div>
                    <div class="form-group">
                        <label for="kuotaTerisi">Kuota Terisi</label>
                        <input type="number" class="form-control" id="kuotaTerisi" placeholder="Masukkan kuota terisi" min="0" value="0">
                    </div>
                </form>
            </div>
